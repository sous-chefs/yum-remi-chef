...
when 'amazon'
  # Default to EL6
  # default['yum']['remi-php55']['baseurl'] = 'http://cdn.remirepo.net/enterprise/6/php55/$basearch/'
  default['yum']['remi-php55']['mirrorlist'] = 'http://cdn.remirepo.net/enterprise/6/php55/mirror'
