...
when 'amazon'
  # Use CentOS 7 repo
  # default['yum']['remi-safe']['baseurl'] = 'http://cdn.remirepo.net/enterprise/7/remi/$basearch/'
  default['yum']['remi-safe']['mirrorlist'] = 'http://cdn.remirepo.net/enterprise/7/safe/mirror'
