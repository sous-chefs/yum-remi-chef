...
case node['platform']
when 'fedora'
  default['yum']['remi-php71-debuginfo']['baseurl'] = "http://cdn.remirepo.net/fedora/#{node['platform_version'].to_i}/debug-php71/$basearch/"
...
when 'amazon'
  # Default to EL6
  default['yum']['remi-php71-debuginfo']['baseurl'] = 'http://cdn.remirepo.net/enterprise/6/debug-php71/$basearch/'
  default['yum']['remi-php71-debuginfo']['description'] = "Remi's PHP 7.1 RPM repository for Enterprise Linux 6 - $basearch - debuginfo"
else
  default['yum']['remi-php71-debuginfo']['baseurl'] = "http://cdn.remirepo.net/enterprise/#{node['platform_version'].to_i}/debug-php71/$basearch/"
