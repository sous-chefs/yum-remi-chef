...
when 'amazon'
  # Default to EL6
  # default['yum']['remi-test']['baseurl'] = 'http://cdn.remirepo.net/enterprise/6/remi-test/$basearch/'
  default['yum']['remi-test']['mirrorlist'] = 'http://cdn.remirepo.net/enterprise/6/remi-test/mirror'
