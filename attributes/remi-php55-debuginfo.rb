...
case node['platform']
when 'fedora'
  default['yum']['remi-php55-debuginfo']['baseurl'] = "http://rpms.famillecollet.com/fedora/#{node['platform_version'].to_i}/debug-php55/$basearch/"
  default['yum']['remi-php55-debuginfo']['description'] = "Les RPM de remi de PHP 5.5 pour Fedora Linux #{node['platform_version'].to_i} - $basearch - debuginfo"
else
