...
case node['platform']
when 'fedora'
  default['yum']['remi-debuginfo']['baseurl'] = "http://rpms.famillecollet.com/fedora/#{node['platform_version'].to_i}/debug-remi/$basearch/"
  default['yum']['remi-debuginfo']['description'] = "Les RPM de remi pour Fedora Linux #{node['platform_version'].to_i} - $basearch - debuginfo"
else
