...
case node['platform']
when 'fedora'
  default['yum']['remi-debuginfo']['baseurl'] = "http://cdn.remirepo.net/fedora/#{node['platform_version'].to_i}/debug-remi/$basearch/"
...
when 'amazon'
  # Default to EL7
  default['yum']['remi-debuginfo']['baseurl'] = 'http://cdn.remirepo.net/enterprise/7/debug-remi/$basearch/'
  default['yum']['remi-debuginfo']['description'] = "Remi's RPM repository for Enterprise Linux 7 - $basearch - debuginfo"
else
  default['yum']['remi-debuginfo']['baseurl'] = "http://cdn.remirepo.net/enterprise/#{node['platform_version'].to_i}/debug-remi/$basearch/"
