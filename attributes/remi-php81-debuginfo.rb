...
when 'amazon'
  # Default to EL7
  default['yum']['remi-php81-debuginfo']['baseurl'] = 'http://rpms.remirepo.net/enterprise/7/debug-php81/$basearch/'
  default['yum']['remi-php81-debuginfo']['description'] = "Remi's PHP 8.1 RPM repository for Enterprise Linux 7 - $basearch - debuginfo"
else
