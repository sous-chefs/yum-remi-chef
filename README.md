...
Amazon Linux is _not_ supported by the Remi repository. Amazon maintains their own PHP packages natively, as php53,
php54, php55, php56 and php70.

Remirepo does not support php < 7.2 on CentOS 8.
