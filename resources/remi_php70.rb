...
property :baseurl, String, default: lazy { remi_repo_baseurl('remi-php70') }
property :mirrorlist, String, default: lazy { remi_repo_mirrorlist('remi-php70') }
property :description, String, default: lazy { remi_repo_description('remi-php70') }
