...
property :baseurl, String, default: lazy { remi_repo_baseurl('remi-php81') }
property :mirrorlist, String, default: lazy { remi_repo_mirrorlist('remi-php81') }
property :description, String, default: lazy { remi_repo_description('remi-php81') }
